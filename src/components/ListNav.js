...
const ListNav = ({title, alarmArray, mentoAlarm, dataUrl, arrow, closeNav, bookmarkMento}) => {
    ...
    return(
        <Partition>
            <AlogList>
                ...
                <MentoList title={title[2]} mentoAlarm={mentoAlarm} arrow={arrow} closeNav={closeNav} bookmarkMento={bookmarkMento}></MentoList>
